...
import { TabNavigator, createBottomTabNavigator, createMaterialTopTabNavigator, createStackNavigator, StackNavigator } from 'react-navigation';
 ...
 */
export const AppNavigatorTab = createStackNavigator({
  Tab: {
    screen: TabScreen,
  },
},
